...
<div style="height:600px">
    <asp:Panel ID="Panel1" runat="server" Height="352px" Style="z-index: 100; left: 341px;
    ...
    <asp:Button ID="saveButton" runat="server"  Style="z-index: 101;
        left: 504px; position: absolute; top: 704px" Text="Save" Width="54px" OnClick="saveButton_Click" />
    ...
    <asp:GridView ID="projectGridView" runat="server" Style="z-index: 104; left: 210px;
        position: absolute; top: 759px" OnSelectedIndexChanged="projectGridView_SelectedIndexChanged">
    </asp:GridView>
    <table>
        <tr>
